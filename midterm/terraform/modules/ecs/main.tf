...
resource "aws_ecs_service" "this" {
  ...
  # KEY CHANGES - Add these two lines to implement minimum healthy percentage
  deployment_minimum_healthy_percent = 66   # Keep at least 2 of 3 tasks (66%)
  deployment_maximum_percent         = 200  # Can scale to 6 during deployments
